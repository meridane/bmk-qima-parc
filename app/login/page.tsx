  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-r from-orange-500 to-black">
      <div className="bg-white p-10 rounded-2xl shadow-2xl max-w-sm w-full">
        ...
        <div className="flex gap-4 justify-center mb-6">
          <button
            ...
            className={`flex-1 px-4 py-2 rounded-xl text-white font-semibold transition ${
              role === 'client' ? 'bg-orange-600' : 'bg-gray-500 hover:bg-orange-500'
            }`}
          >
            Client
          </button>
          <button
            ...
            className={`flex-1 px-4 py-2 rounded-xl text-white font-semibold transition ${
              role === 'admin' ? 'bg-black' : 'bg-gray-500 hover:bg-black'
            }`}
          >
            Superviseur
          </button>
        ...
        <button
          onClick={handleLogin}
          className="w-full bg-black hover:bg-orange-600 text-white py-3 px-4 rounded-xl font-semibold transition"
        >
