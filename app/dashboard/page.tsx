  ...
  return (
    <div className="min-h-screen p-6 bg-gray-50 text-gray-900">
      <div className="bg-white rounded-2xl shadow p-6 max-w-4xl mx-auto">
        ...
        <h2 className="text-2xl font-bold mb-4">Tableau de bord Client</h2>
        ...
        {conteneur ? (
          <div className="mb-6">
            ...
            <div className="w-full bg-gray-200 rounded-full h-4 mt-2">
              <div
                className="bg-orange-500 h-4 rounded-full text-right px-2 text-white text-xs"
        ...
        <h3 className="text-xl font-semibold mb-2">Mes voitures</h3>
